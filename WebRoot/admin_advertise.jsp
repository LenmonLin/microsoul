    ...
    Vue.component('goods_issue',{
          ...
          methods:{
            ...
            var info=this.info;
                          ...
                          var that=this;
                          $.ajax({
                            url :'http://localhost:8080/microsoul/content/insert.do',
                            type :'post',
                            data:{
            ...
            goodsEdit(){
              ...
              var that=this;
              $.ajax({
                url :'http://localhost:8080/microsoul/content/update.do',
                type :'post',
                data:{
                contentId:info.contentId,
                title:info.title,
          ...
          handleDelete(index,row,rows){
            ...
            this.$confirm('此操作将会删除商品，是否继续？','警告',{
              ...
              type:'warning'
            	...
            	$.ajax({
            	      url : 'http://localhost:8080/microsoul/content/delete.do',
            	      type : 'post',
            	      data:{
            	    	  contentId:goodsId
            	      },
